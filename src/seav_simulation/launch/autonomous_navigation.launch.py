...
def generate_launch_description():
    # Find the nav2_bringup and seav_simulation packages
    ...
    nav2_params_file_path = os.path.join(pkg_seav_simulation, 'params', 'nav2_params.yaml')

    # Declare launch arguments
    declare_map_file_path_cmd = DeclareLaunchArgument(
        name='map_file_path',
        default_value='./src/seav_simulation/maps/house_map.yaml',
